...
use Modules\ApiService\Models\ApiRoleResource;
...
class ApiRoleController extends BackendController
{
    ...
    {
        $listing = new \Modules\ApiService\View\Components\ApiRole\Listing();
        $layout = $this->layout();
    ...
    public function add()
    {
        ...
        $apiRole = new ApiRole();
        $edit = new \Modules\ApiService\View\Components\ApiRole\Listing\Edit();
        $edit->row($apiRole);
        $layout  = $this->layout();
        $content = $layout->child('content');
     ...
     public function save(Request $request){
        try{
            ...
            if($apiRole->id){
                return redirect()->route('admin.apirole.edit',['id'=>$apiRole->id])->with('success','Record saved');
            }
            else{
