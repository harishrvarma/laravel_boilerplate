...
use Modules\ApiService\Models\ApiUserRole;
...
class ApiUserController extends BackendController
{
    ...
    {
        $listing = new \Modules\ApiService\View\Components\ApiUser\Listing();
        $layout = $this->layout();
    ...
    public function add()
    {
        ...
        $apiUser = new ApiUser();
        $edit = new \Modules\ApiService\View\Components\ApiUser\Listing\Edit();
        $edit->row($apiUser);
        $layout  = $this->layout();
        $content = $layout->child('content');
