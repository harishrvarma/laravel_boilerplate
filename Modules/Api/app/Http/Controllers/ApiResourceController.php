...
class ApiResourceController extends BackendController
{
    ...
    {
        $listing = new \Modules\Api\View\Components\ApiResource\Listing();
        $layout = $this->layout();
    ...
    public function add()
    {
        ...
        $edit = new \Modules\Api\View\Components\ApiResource\Listing\Edit();
     ...
     public function save(Request $request){
        try{
            ...
            if($apiResource->id){
                return redirect()->route('admin.system.apiresource.edit',['id'=>$apiResource->id])->with('success','Record saved');
            }
            else{
    ...
    public function delete(Request $request){
        try{
            ...
            $apiResource->delete();
            return redirect()->route('admin.system.apiresource.listing')->with('success','Record deleted');
        }
        catch (Exception $e){
            return redirect()->back()->with('error',$e);
        }
    ...
    public function massDelete(Request $request){
        try{
            ...
            return redirect()->route('admin.system.apiresource.listing')->with('success','Records deleted');
        }
        catch (Exception $e){
            return redirect()->back()->with('error',$e);
        }
